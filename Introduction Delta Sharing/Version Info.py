...
# MAGIC * Version:  **Build**
# MAGIC * Built On: **Jan 6, 2023 at 10:40:42 UTC**
...
# MAGIC 
# MAGIC This course is tested against and requires one of the following DBRs (Databricks Runtime): **11.3.x-scala2.12, 11.3.x-photon-scala2.12, 11.2.x-scala2.12, 11.2.x-photon-scala2.12**.
# MAGIC 
